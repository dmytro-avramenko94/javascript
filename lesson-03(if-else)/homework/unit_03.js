...
function f1() {
   ...
   out1.innerHTML = Boolean(inp1.value == 4)
}
...
function f7() {
   ...
   out7.innerHTML = Math.pow(inp71.value, inp72.value)
}
...
function f13() {
   ...
   out13.innerHTML = typeof (inp13.value)
}
...
function f14() {
   ...
   if (sel14.value == '+') {
      out14.innerHTML = Number(inp141.value) + Number(inp142.value)
   }
   else if (sel14.value == '-') {
...
function f15() {
   ...
   if (sel153.value == '&&') {
      out15.innerHTML = sel151.value + "&&" + sel152.value
   }
   else {
      out15.innerHTML = sel151.value + "||" + sel152.value
   }
