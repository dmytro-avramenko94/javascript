...
function t12() {
    let inp1 = document.querySelector('.i-12-1')
    let inp2 = document.querySelector('.i-12-2')
    let out = document.querySelector('.out-12')
    out.innerHTML = `Hello ${inp1.value} ${inp2.value}`
}
...
function t13() {
    let inp1 = document.querySelector('.i-13-1')
    let inp2 = document.querySelector('.i-13-2')
...
function t16() {
    let inp1 = document.querySelector('.i-16-1')
    let inp2 = document.querySelector('.i-16-2')
...
function t19() {
    let inp1 = document.querySelector('.i-19-1')
    let inp2 = document.querySelector('.i-19-2')
